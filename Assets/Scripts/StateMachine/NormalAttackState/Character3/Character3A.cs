...
public class Character3A : NormalAttackState
{
    private Character3AA _aaState;
    private Character3AB _abState;
    ...
    {
        _aaState = new Character3AA(entityController, normalAttackStateMachine, parentStateMachine);
        _abState = new Character3AB(entityController, normalAttackStateMachine, parentStateMachine);
