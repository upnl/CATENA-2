...
public class Character3AA : NormalAttackState
{
    // private Character1AAA _aaaState;
    private Character3AAB _aabState;
        ...
        : base(entityController, normalAttackStateMachine, parentStateMachine)
    {
        ...
        _aabState = new Character3AAB(entityController, normalAttackStateMachine, parentStateMachine);
